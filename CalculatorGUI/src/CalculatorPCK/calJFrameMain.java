...
public class calJFrameMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("oscar calculator");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // TODO add your handling code here:
        ExtractNums en = new ExtractNums(input);
        en.extract();
        num1 = en.getNum1();
        num2 = en.getNum2();
        symbol = en.getSymbol();
        CalMethodsClass cMc = new CalMethodsClass(num1, num2, symbol);
        ans = cMc.getAns();
        
        input += "" +"="+ ans;
        jTextField1.setText(input);
        HistoryFileManager hfm = new HistoryFileManager(jTextField1.getText());
        
        hfm.writeToFile(count);
        count++;
        hfm.extractHis();
        jLabel3.setText("1:"+" "+hfm.getHistory1());
        jLabel4.setText("2:"+" "+hfm.getHistory2());
        jLabel5.setText("3:"+" "+hfm.getHistory3());
        jLabel6.setText("4:"+" "+hfm.getHistory4());
        jLabel7.setText("5:"+" "+hfm.getHistory5());
        input="";
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        for(int x =0; x < jTextField1.getText().length(); x++){
            char c = jTextField1.getText().charAt(x);
            if(c == '='){
                input="";
                jTextField1.setText(input);
                break;
            }else if(x == jTextField1.getText().length()-1){
                for(int z = 0; z < jTextField1.getText().length()-1; z++){
                    newIn += jTextField1.getText().charAt(z);
                }
                input = newIn;
                jTextField1.setText(newIn);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calJFrameMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calJFrameMain().setVisible(true);
            }
        });
    }
